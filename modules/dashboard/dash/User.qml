...
Row {
    ...
    StyledClippingRect {
        ...
        color: Colours.layer(ComponentColors.region.dashboard.user.avatar.container.background, 2)
        ...
        MouseArea {
            ...
            StyledRect {
                ...
                color: Qt.alpha(ComponentColors.region.state.semantic.overlay.scrim, 0.5)
            ...
            StyledRect {
                ...
                color: ComponentColors.region.dashboard.user.avatar.action.bg
                scale: parent.containsMouse ? 1 : 0.5
                opacity: parent.containsMouse ? 1 : 0

                StateLayer {
                    color: ComponentColors.region.dashboard.user.avatar.action.icon
    ...
    Column {
        ...
        Item {
            ...
            ColouredIcon {
                ...
                colour: ComponentColors.region.dashboard.user.info.icon.os
            }
        ...
        InfoLine {
            ...
            text: SysInfo.wm
            colour: ComponentColors.region.dashboard.user.info.icon.wm
        }
        ...
        InfoLine {
            ...
            colour: ComponentColors.region.dashboard.user.info.icon.uptime
        }
    }
