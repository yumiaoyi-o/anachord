...
Item {
    ...
    Item {
        ...
        StyledRect {
            ...
            color: ComponentColors.region.dashboard.tabs.line.indicator
    ...
    StyledRect {
        ...
        implicitHeight: 1
        color: ComponentColors.region.dashboard.tabs.line.divider
    }
        ...
        contentItem: CustomMouseArea {
            ...
            ClippingRectangle {
                ...
                StyledRect {
                    ...
                    color: tab.current ? ComponentColors.region.dashboard.tabs.state.activeIcon : ComponentColors.region.dashboard.tabs.state.inactiveIcon
            ...
            StyledText {
                ...
                text: tab.text
                color: tab.current ? ComponentColors.region.dashboard.tabs.state.activeLabel : ComponentColors.region.dashboard.tabs.state.inactiveLabel
            }
        }
    }
}
