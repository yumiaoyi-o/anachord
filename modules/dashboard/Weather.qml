...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column {
                ...
                StyledText {
                    ...
                    font.weight: 600
                    color: ComponentColors.region.dashboard.weather.header.city
                }

                StyledText {
                    text: new Date().toLocaleDateString(Qt.locale(), "dddd, MMMM d")
                    font.pointSize: Appearance.font.size.small
                    color: ComponentColors.region.dashboard.weather.header.date
                }
            }
            ...
            Row {
                ...
                WeatherStat {
                    ...
                    colour: ComponentColors.region.dashboard.weather.current.sunriseSunset
                }
        ...
        StyledRect {
            ...
            color: Colours.layer(ComponentColors.region.dashboard.weather.current.card)
            ...
            RowLayout {
                ...
                MaterialIcon {
                    ...
                    color: ComponentColors.region.dashboard.weather.current.icon
                    animate: true
                }
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        ...
                        font.weight: 500
                        color: ComponentColors.region.dashboard.weather.current.temperature
                    }
                    ...
                    StyledText {
                        ...
                        color: ComponentColors.region.dashboard.weather.current.description
                    }
                }
            }
        }
