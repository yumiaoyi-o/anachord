    ...
    StyledListView {
        ...
        delegate: RowLayout {
            ...
            StyledText {
                ...
                color: ComponentColors.region.utilities.cards.recordings.list.text
            ...
            IconButton {
                icon: "delete_forever"
                type: IconButton.Text
                label.color: ComponentColors.region.state.semantic.feedback.error
                stateLayer.color: ComponentColors.region.state.semantic.feedback.error
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                MaterialIcon {
                    ...
                    text: "scan_delete"
                    color: ComponentColors.region.utilities.cards.recordings.empty.border
