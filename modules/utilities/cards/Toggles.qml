...
StyledRect {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Toggle {
                icon: "settings"
                inactiveOnColour: ComponentColors.region.utilities.toggle.state.labelInactive
                toggle: false
                onClicked: {
    ...
    component Toggle: IconButton {
        ...
        inactiveColour: Colours.layer(ComponentColors.region.utilities.toggle.state.pillInactive, 2)
        toggle: true
