...
StyledRect {
    ...
    color: Colours.layer(ComponentColors.region.utilities.cards.idleInhibit.container.surface)
    clip: true
    ...
    RowLayout {
        ...
        StyledRect {
            ...
            color: IdleInhibitor.enabled ? ComponentColors.region.utilities.cards.idleInhibit.status.activeBg : ComponentColors.region.utilities.cards.idleInhibit.status.inactiveBg
            ...
            MaterialIcon {
                ...
                text: "coffee"
                color: IdleInhibitor.enabled ? ComponentColors.region.utilities.cards.idleInhibit.status.activeIcon : ComponentColors.region.utilities.cards.idleInhibit.status.inactiveIcon
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: ComponentColors.region.utilities.cards.idleInhibit.subtitle
    ...
    Loader {
        ...
        sourceComponent: StyledRect {
            ...
            radius: Appearance.rounding.full
            color: ComponentColors.region.utilities.cards.idleInhibit.chip.bg
            ...
            StyledText {
                ...
                color: ComponentColors.region.utilities.cards.idleInhibit.chip.fg
