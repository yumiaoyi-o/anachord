    ...
    sourceComponent: MouseArea {
        ...
        Item {
            ...
            StyledRect {
                ...
                color: ComponentColors.region.utilities.modal.overlay.scrim
            }
            ...
            Shape {
                ...
                ShapePath {
                    ...
                    fillGradient: LinearGradient {
                        ...
                        GradientStop {
                            position: 0
                            color: Qt.alpha(ComponentColors.region.utilities.modal.overlay.scrim, 0)
                        }
                        GradientStop {
                            position: 1
                            color: ComponentColors.region.utilities.modal.overlay.scrim
        ...
        StyledRect {
            ...
            color: ComponentColors.region.utilities.modal.content.surface
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.utilities.modal.content.text
