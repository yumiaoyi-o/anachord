...
ColumnLayout {
    ...
    StyledRect {
        ...
        color: Colours.layer(ComponentColors.region.bar.popout.container.surface)
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: ComponentColors.region.bar.chrome.foreground.disabled
            ...
            StyledText {
                ...
                color: connectButton.hasError ? ComponentColors.region.state.semantic.feedback.error : ComponentColors.region.bar.popout.foreground.subtext
                font.pointSize: Appearance.font.size.small
                font.weight: 400
            ...
            FocusScope {
                ...
                StyledRect {
                    anchors.fill: parent
                    radius: Appearance.rounding.normal
                    color: passwordContainer.activeFocus ? Qt.lighter(Colours.layer(ComponentColors.region.bar.popout.container.surface), 1.05) : Colours.layer(ComponentColors.region.bar.popout.container.surface)
                    ...
                    border.color: {
                        ...
                        if (passwordContainer.activeFocus) {
                            return ComponentColors.region.bar.chrome.accent.primary;
                        }
                        return root.shouldBeVisible ? ComponentColors.region.bar.chrome.foreground.disabled : "transparent";
                    }
                ...
                ListView {
                    ...
                    delegate: StyledRect {
                        ...
                        color: ComponentColors.region.bar.popout.foreground.text
            ...
            RowLayout {
                ...
                TextButton {
                    ...
                    inactiveColour: ComponentColors.region.bar.popout.button.bg
                    inactiveOnColour: ComponentColors.region.bar.popout.button.text
                    text: qsTr("Cancel")
                ...
                TextButton {
                    ...
                    Layout.fillWidth: true
                    Layout.minimumHeight: Appearance.font.size.normal + Appearance.padding.normal * 2
                    inactiveColour: ComponentColors.region.bar.chrome.accent.primary
                    inactiveOnColour: ComponentColors.region.bar.chrome.accent.onPrimary
                    text: qsTr("Connect")
