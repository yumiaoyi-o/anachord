...
ColumnLayout {
    ...
    StyledText {
        ...
        color: ComponentColors.region.bar.popout.network.section.subtitle
    ...
    Repeater {
        ...
        RowLayout {
            ...
            MaterialIcon {
                ...
                color: networkItem.modelData.active ? ComponentColors.region.bar.popout.network.item.icon.active : ComponentColors.region.bar.popout.network.item.icon.inactive
            }
            ...
            StyledText {
                ...
                color: networkItem.modelData.active ? ComponentColors.region.bar.popout.network.item.label.active : ComponentColors.region.bar.popout.network.item.label.inactive
            }
            ...
            StyledRect {
                ...
                color: Qt.alpha(ComponentColors.region.bar.popout.network.item.action.bgActive, networkItem.modelData.active ? 1 : 0)
                ...
                StateLayer {
                    color: networkItem.modelData.active ? ComponentColors.region.bar.popout.network.item.action.fgActive : ComponentColors.region.bar.popout.network.item.action.fgInactive
    ...
    StyledRect {
        ...
        radius: Appearance.rounding.full
        color: ComponentColors.region.bar.popout.network.rescan.bg

        StateLayer {
            color: ComponentColors.region.bar.popout.network.rescan.fg
    ...
    Repeater {
        ...
        RowLayout {
            ...
            MaterialIcon {
                text: "cable"
                color: ethernetItem.modelData.connected ? ComponentColors.region.bar.popout.network.item.icon.active : ComponentColors.region.bar.popout.network.item.icon.inactive
            }
            ...
            StyledText {
                ...
                color: ethernetItem.modelData.connected ? ComponentColors.region.bar.popout.network.item.label.active : ComponentColors.region.bar.popout.network.item.label.inactive
            }
            ...
            StyledRect {
                ...
                radius: Appearance.rounding.full
                color: Qt.alpha(ComponentColors.region.bar.popout.network.item.action.bgActive, ethernetItem.modelData.connected ? 1 : 0)
                ...
                StateLayer {
                    color: ethernetItem.modelData.connected ? ComponentColors.region.bar.popout.network.item.action.fgActive : ComponentColors.region.bar.popout.network.item.action.fgInactive
