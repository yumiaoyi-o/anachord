    ...
    component SubMenu: Column {
        ...
        Repeater {
            ...
            StyledRect {
                ...
                color: modelData.isSeparator ? ComponentColors.region.bar.popout.tray.item.divider : "transparent"
                ...
                Loader {
                    ...
                    sourceComponent: Item {
                        ...
                        StyledText {
                            ...
                            color: item.modelData.enabled ? ComponentColors.region.bar.popout.tray.item.textEnabled : ComponentColors.region.bar.popout.tray.item.textDisabled
                        }
            ...
            sourceComponent: Item {
                ...
                Item {
                    ...
                    StyledRect {
                        ...
                        radius: Appearance.rounding.full
                        color: ComponentColors.region.bar.popout.tray.back.button.bg

                        StateLayer {
                            radius: parent.radius
                            color: ComponentColors.region.bar.popout.tray.back.button.text
