...
StyledRect {
    ...
    color: Qt.alpha(ComponentColors.region.bar.workspace.container.surface, (Config.bar.tray.background && items.count > 0) ? Colours.layer(ComponentColors.region.bar.workspace.container.surface).a : 0)
