...
StyledRect {
    ...
    property color colour: ComponentColors.region.bar.chrome.foreground.icon
    readonly property alias items: iconColumn

    color: Qt.alpha(ComponentColors.region.bar.workspace.container.surface, Colours.layer(ComponentColors.region.bar.workspace.container.surface).a)
    ...
    ColumnLayout {
        ...
        WrappedLoader {
            ...
            sourceComponent: MaterialIcon {
                ...
                color: !UPower.onBattery || UPower.displayDevice.percentage > 0.2 ? root.colour : ComponentColors.region.state.semantic.feedback.error
                fill: 1
            }
        }
    }
