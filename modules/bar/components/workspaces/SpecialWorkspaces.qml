    ...
    Loader {
        ...
        sourceComponent: Item {
            StyledClippingRect {
                ...
                color: ComponentColors.region.bar.chrome.accent.tertiary
                radius: Appearance.rounding.full

                Colouriser {
                    source: view
                    sourceColor: ComponentColors.region.bar.chrome.foreground.text
                    colorizationColor: ComponentColors.region.bar.chrome.accent.onTertiary
