...
StyledRect {
    ...
    color: {
        const c = root.modelData.urgency === "critical" ? ComponentColors.region.sidebar.notifications.item.criticalBg : Colours.layer(ComponentColors.region.sidebar.notifications.item.normalBg, 2);
    ...
    StyledText {
        ...
        color: root.modelData.urgency === "critical" ? ComponentColors.region.sidebar.notifications.item.criticalText : ComponentColors.region.sidebar.notifications.item.normalText
    ...
    WrappedLoader {
        ...
        sourceComponent: StyledText {
            ...
            color: root.modelData.urgency === "critical" ? ComponentColors.region.sidebar.notifications.item.criticalBody : ComponentColors.region.sidebar.notifications.item.normalBody
            elide: Text.ElideRight
        }
    }
    ...
    WrappedLoader {
        ...
        sourceComponent: StyledText {
            ...
            color: ComponentColors.region.sidebar.notifications.item.time
