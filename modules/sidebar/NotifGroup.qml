...
StyledRect {
    ...
    color: Colours.layer(ComponentColors.region.sidebar.notifications.group.surface, 2)
        ...
        Item {
            ...
            Component {
                ...
                ColouredIcon {
                    ...
                    colour: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.notifications.group.icon.critical : root.urgency === NotificationUrgency.Low ? ComponentColors.region.sidebar.notifications.group.icon.low : ComponentColors.region.sidebar.notifications.group.icon.normal
            ...
            Component {
                ...
                MaterialIcon {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.notifications.group.icon.critical : root.urgency === NotificationUrgency.Low ? ComponentColors.region.sidebar.notifications.group.icon.low : ComponentColors.region.sidebar.notifications.group.icon.normal
            ...
            StyledClippingRect {
                anchors.fill: parent
                color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.notifications.group.badge.criticalBg : root.urgency === NotificationUrgency.Low ? Colours.layer(ComponentColors.region.sidebar.notifications.group.badge.lowBg, 3) : ComponentColors.region.sidebar.notifications.group.badge.normalBg
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.notifications.group.badge.criticalBg : root.urgency === NotificationUrgency.Low ? ComponentColors.region.sidebar.notifications.group.badge.lowBg : ComponentColors.region.sidebar.notifications.group.badge.normalBg
                    radius: Appearance.rounding.full
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: root.modelData
                    color: ComponentColors.region.sidebar.notifications.group.appName
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.sidebar.notifications.group.time
                    font.pointSize: Appearance.font.size.small
                }
                ...
                StyledRect {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.notifications.group.counter.criticalBg : Colours.layer(ComponentColors.region.sidebar.notifications.group.counter.normalBg, 3)
                    radius: Appearance.rounding.full

                    StateLayer {
                        color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.notifications.group.counter.criticalText : ComponentColors.region.sidebar.notifications.group.counter.normalText
