    ...
    RowLayout {
        ...
        StyledText {
            ...
            color: {
                ...
                if (!root.math)
                    return ComponentColors.region.launcher.calc.field.placeholder;
                return ComponentColors.region.launcher.calc.field.result;
            }
        ...
        StyledRect {
            color: ComponentColors.region.launcher.calc.button.bg
            radius: Appearance.rounding.normal
            clip: true
            ...
            StateLayer {
                ...
                color: ComponentColors.region.launcher.calc.button.text
