...
Item {
    ...
    StyledText {
        ...
        animate: true
        color: root.pam.authenticating ? ComponentColors.region.lock.typography.role.secondary : ComponentColors.region.lock.typography.role.disabled
