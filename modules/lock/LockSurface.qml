...
WlSessionLockSurface {
    ...
    color: ComponentColors.region.lock.layout.background
        ...
        Item {
            ...
            Item {
                ...
                WavyLines {
                    ...
                    anchors.fill: parent
                    lineColor: ComponentColors.region.lock.visualiser.wave.tertiary
                }
            }
    ...
    component WavyLines: ShaderEffect {
        ...
        property color lineColor: ComponentColors.region.lock.layout.background
