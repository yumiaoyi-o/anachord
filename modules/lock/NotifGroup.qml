...
StyledRect {
    ...
    color: root.urgency === "critical" ? ComponentColors.region.lock.notifications.group.container.bg : Colours.layer(ComponentColors.region.lock.card.surface.high, 2)
        ...
        Item {
            ...
            Component {
                ...
                ColouredIcon {
                    ...
                    colour: root.urgency === "critical" ? ComponentColors.region.state.semantic.feedback.error : root.urgency === "low" ? ComponentColors.region.lock.typography.role.primary : ComponentColors.region.lock.notifications.group.content.text
            ...
            Component {
                ...
                MaterialIcon {
                    ...
                    color: root.urgency === "critical" ? ComponentColors.region.state.semantic.feedback.error : root.urgency === "low" ? ComponentColors.region.lock.typography.role.primary : ComponentColors.region.lock.notifications.group.content.text
            ...
            ClippingRectangle {
                anchors.fill: parent
                color: root.urgency === "critical" ? ComponentColors.region.state.semantic.feedback.error : root.urgency === "low" ? Colours.layer(ComponentColors.region.lock.card.surface.highest, 3) : ComponentColors.region.lock.notifications.group.container.bg
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    ...
                    color: root.urgency === "critical" ? ComponentColors.region.state.semantic.feedback.error : root.urgency === "low" ? ComponentColors.region.lock.card.surface.highest : ComponentColors.region.lock.notifications.group.container.bg
                    radius: Appearance.rounding.full
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.lock.outline.stroke.border
                    font.pointSize: Appearance.font.size.small
                }
                ...
                StyledRect {
                    ...
                    color: root.urgency === "critical" ? ComponentColors.region.state.semantic.feedback.error : Colours.layer(ComponentColors.region.lock.card.surface.highest, 2)
                    radius: Appearance.rounding.full
                    ...
                    StateLayer {
                        color: root.urgency === "critical" ? ComponentColors.region.state.semantic.feedback.error : ComponentColors.region.lock.typography.role.primary
    ...
    component NotifLine: StyledText {
        ...
        text: {
            ...
            const colour = root.urgency === "critical" ? ComponentColors.region.lock.tones.role.secondary : ComponentColors.region.lock.outline.stroke.border;
        ...
        color: root.urgency === "critical" ? ComponentColors.region.lock.notifications.group.content.text : ComponentColors.region.lock.typography.role.primary
