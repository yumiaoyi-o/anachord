...
Item {
        ...
        Loader {
            ...
            sourceComponent: StyledRect {
                ...
                StateLayer {
                    ...
                    color: ComponentColors.region.shared.controls.common.onAccent
    ...
    component NavItem: Item {
        ...
        StyledRect {
            ...
            StateLayer {
                color: item.active ? ComponentColors.region.dashboard.tabs.state.activeIcon : ComponentColors.region.dashboard.tabs.state.inactiveIcon
            ...
            StyledText {
                ...
                opacity: 0
                text: item.label
                color: item.active ? ComponentColors.region.dashboard.tabs.state.activeLabel : ComponentColors.region.dashboard.tabs.state.inactiveLabel
