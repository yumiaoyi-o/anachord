...
DeviceList {
    ...
    titleSuffix: Component {
        StyledText {
            ...
            text: qsTr("Scanning...")
            color: ComponentColors.region.panel.controlCenter.network.wireless.accent
    ...
    delegate: Component {
        StyledRect {
            ...
            color: Qt.alpha(Colours.layer(ComponentColors.region.panel.controlCenter.network.wireless.surface), root.activeItem === modelData ? Colours.layer(ComponentColors.region.panel.controlCenter.network.wireless.surface).a : 0)
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    radius: Appearance.rounding.normal
                    color: modelData.active ? ComponentColors.region.panel.controlCenter.network.wireless.accent : Colours.layer(ComponentColors.region.panel.controlCenter.network.wireless.surfaceHigh)
                    ...
                    MaterialIcon {
                        ...
                        color: modelData.active ? ComponentColors.region.panel.controlCenter.network.wireless.onAccent : ComponentColors.region.panel.controlCenter.network.wireless.text
                    }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            color: modelData.active ? ComponentColors.region.panel.controlCenter.network.wireless.accent : ComponentColors.region.panel.controlCenter.network.wireless.border
                            font.pointSize: Appearance.font.size.small
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.panel.controlCenter.network.wireless.accent, modelData.active ? 1 : 0)
