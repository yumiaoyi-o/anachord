        ...
        ListView {
            ...
            delegate: Component {
                StyledRect {
                    ...
                    color: Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surfaceHigh)
                    ...
                    RowLayout {
                        ...
                        MaterialIcon {
                            ...
                            color: modelData.isActive ? ComponentColors.region.panel.controlCenter.network.vpn.accent : ComponentColors.region.panel.controlCenter.network.vpn.border
                        }
