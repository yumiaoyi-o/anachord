...
ColumnLayout {
    ...
    StyledText {
        ...
        color: ComponentColors.region.panel.controlCenter.network.ethernet.border
    }
    ...
    StyledRect {
        ...
        color: Colours.layer(ComponentColors.region.panel.controlCenter.network.ethernet.surface)
