...
ColumnLayout {
    ...
    TextButton {
        ...
        inactiveColour: ComponentColors.region.panel.controlCenter.network.vpn.accent
        inactiveOnColour: ComponentColors.region.panel.controlCenter.network.vpn.onAccent
    ...
    ListView {
        ...
        delegate: Component {
            StyledRect {
                ...
                color: Qt.alpha(Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surface), (root.session && root.session.vpn && root.session.vpn.active === modelData) ? Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surface).a : 0)
                ...
                RowLayout {
                    ...
                    StyledRect {
                        ...
                        radius: Appearance.rounding.normal
                        color: modelData.enabled && VPN.connected ? ComponentColors.region.panel.controlCenter.network.vpn.accent : Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surfaceHigh)
                        ...
                        MaterialIcon {
                            ...
                            color: modelData.enabled && VPN.connected ? ComponentColors.region.panel.controlCenter.network.vpn.onAccent : ComponentColors.region.panel.controlCenter.network.vpn.text
                        }
                    }
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                ...
                                color: modelData.enabled ? (VPN.connected ? ComponentColors.region.panel.controlCenter.network.vpn.accent : ComponentColors.region.panel.controlCenter.network.vpn.text) : ComponentColors.region.panel.controlCenter.network.vpn.border
                    ...
                    StyledRect {
                        ...
                        color: Qt.alpha(ComponentColors.region.panel.controlCenter.network.vpn.accent, VPN.connected && modelData.enabled ? 1 : 0)
                        ...
                        MaterialIcon {
                            ...
                            color: VPN.connected && modelData.enabled ? ComponentColors.region.panel.controlCenter.network.vpn.onAccent : ComponentColors.region.panel.controlCenter.network.vpn.text
                        }
                    }
                    ...
                    StyledRect {
                        ...
                        MaterialIcon {
                            ...
                            anchors.centerIn: parent
                            text: "delete"
                            color: ComponentColors.region.panel.controlCenter.network.vpn.text
                        }
                    }
                }
    ...
    Popup {
        ...
        background: StyledRect {
            color: ComponentColors.region.panel.controlCenter.network.vpn.surfaceHigh
        ...
        contentItem: Item {
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.panel.controlCenter.network.vpn.border
                    font.pointSize: Appearance.font.size.small
                }
                ...
                TextButton {
                    ...
                    Layout.fillWidth: true
                    text: qsTr("NetBird")
                    inactiveColour: Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surfaceHigh)
                    inactiveOnColour: ComponentColors.region.panel.controlCenter.network.vpn.text
                    onClicked: {
                        const providers = [];
                        for (let i = 0; i < Config.utilities.vpn.provider.length; i++) {
                            providers.push(Config.utilities.vpn.provider[i]);
                ...
                TextButton {
                    ...
                    Layout.fillWidth: true
                    text: qsTr("Cancel")
                    inactiveColour: ComponentColors.region.panel.controlCenter.network.vpn.button.tonalBg
                    inactiveOnColour: ComponentColors.region.panel.controlCenter.network.vpn.button.tonalText
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        ...
                        font.pointSize: Appearance.font.size.small
                        color: ComponentColors.region.panel.controlCenter.network.vpn.subtext
                    }

                    StyledRect {
                        Layout.fillWidth: true
                        implicitHeight: 40
                        color: displayNameField.activeFocus ? Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surface, 3) : Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surface, 2)
                        radius: Appearance.rounding.small
                        border.width: 1
                        border.color: displayNameField.activeFocus ? ComponentColors.region.panel.controlCenter.network.vpn.accent : Qt.alpha(ComponentColors.region.panel.controlCenter.network.vpn.border, 0.3)
                ...
                ColumnLayout {
                    ...
                    StyledRect {
                        Layout.fillWidth: true
                        implicitHeight: 40
                        color: interfaceNameField.activeFocus ? Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surface, 3) : Colours.layer(ComponentColors.region.panel.controlCenter.network.vpn.surface, 2)
                        radius: Appearance.rounding.small
                        border.width: 1
                        border.color: interfaceNameField.activeFocus ? ComponentColors.region.panel.controlCenter.network.vpn.accent : Qt.alpha(ComponentColors.region.panel.controlCenter.network.vpn.border, 0.3)
