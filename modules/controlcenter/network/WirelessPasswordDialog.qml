...
Item {
    ...
    StyledRect {
        ...
        color: Colours.layer(ComponentColors.region.panel.controlCenter.network.wireless.surfaceBase, 0)
        opacity: root.session.network.showPasswordDialog && !root.isClosing ? 1 : 0
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: ComponentColors.region.panel.controlCenter.network.wireless.border
            ...
            StyledText {
                ...
                color: connectButton.hasError ? ComponentColors.region.state.semantic.feedback.error : ComponentColors.region.panel.controlCenter.network.wireless.subtext
                font.pointSize: Appearance.font.size.small
                font.weight: 400
            ...
            Item {
                ...
                StyledRect {
                    anchors.fill: parent
                    radius: Appearance.rounding.normal
                    color: passwordContainer.activeFocus ? Qt.lighter(Colours.layer(ComponentColors.region.panel.controlCenter.network.wireless.surface), 1.05) : Colours.layer(ComponentColors.region.panel.controlCenter.network.wireless.surface)
                    ...
                    border.color: {
                        ...
                        if (passwordContainer.activeFocus) {
                            return ComponentColors.region.panel.controlCenter.network.wireless.accent;
                        }
                        return root.visible ? ComponentColors.region.panel.controlCenter.network.wireless.border : "transparent";
                    }
                ...
                ListView {
                    ...
                    delegate: StyledRect {
                        ...
                        color: ComponentColors.region.panel.controlCenter.network.wireless.text
            ...
            RowLayout {
                ...
                TextButton {
                    ...
                    inactiveColour: ComponentColors.region.panel.controlCenter.network.wireless.button.tonalBg
                    inactiveOnColour: ComponentColors.region.panel.controlCenter.network.wireless.button.tonalText
                    text: qsTr("Cancel")
                ...
                TextButton {
                    ...
                    Layout.fillWidth: true
                    Layout.minimumHeight: Appearance.font.size.normal + Appearance.padding.normal * 2
                    inactiveColour: ComponentColors.region.panel.controlCenter.network.wireless.accent
                    inactiveOnColour: ComponentColors.region.panel.controlCenter.network.wireless.onAccent
                    text: qsTr("Connect")
