...
DeviceList {
    ...
    delegate: Component {
        StyledRect {
            ...
            color: Qt.alpha(Colours.layer(ComponentColors.region.shared.controls.common.surface), root.activeItem === modelData ? Colours.layer(ComponentColors.region.shared.controls.common.surface).a : 0)
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    radius: Appearance.rounding.normal
                    color: device.connected ? ComponentColors.region.shared.controls.common.accent : (device.modelData && device.modelData.bonded) ? ComponentColors.region.shared.controls.button.tonalBg : Colours.layer(ComponentColors.region.shared.controls.common.surfaceHigh)

                    StyledRect {
                        anchors.fill: parent
                        radius: parent.radius
                        color: Qt.alpha(device.connected ? ComponentColors.region.shared.controls.common.onAccent : (device.modelData && device.modelData.bonded) ? ComponentColors.region.shared.controls.button.tonalText : ComponentColors.region.shared.controls.common.text, stateLayer.pressed ? 0.1 : stateLayer.containsMouse ? 0.08 : 0)
                    }
                    ...
                    MaterialIcon {
                        ...
                        color: device.connected ? ComponentColors.region.shared.controls.common.onAccent : (device.modelData && device.modelData.bonded) ? ComponentColors.region.shared.controls.button.tonalText : ComponentColors.region.shared.controls.common.subtext
                        font.pointSize: Appearance.font.size.large
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        ...
                        color: ComponentColors.region.shared.controls.common.border
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.shared.controls.common.accent, device.connected ? 1 : 0)
                    ...
                    StateLayer {
                        color: device.connected ? ComponentColors.region.shared.controls.common.onAccent : ComponentColors.region.shared.controls.common.text
