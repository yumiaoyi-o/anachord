        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.panel.controlCenter.bluetooth.accent, root.session.bt.editingAdapterName ? 1 : 0)

                    StateLayer {
                        color: root.session.bt.editingAdapterName ? ComponentColors.region.panel.controlCenter.bluetooth.onAccent : ComponentColors.region.panel.controlCenter.bluetooth.text
