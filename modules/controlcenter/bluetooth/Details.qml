...
StyledFlickable {
                ...
                Component {
                    ColumnLayout {
                        ...
                        StyledText {
                            ...
                            color: ComponentColors.region.panel.controlCenter.bluetooth.border
                        }
                        ...
                        StyledRect {
                            ...
                            color: Colours.layer(ComponentColors.region.panel.controlCenter.bluetooth.surface)
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Item {
                                        ...
                                        StyledTextField {
                                            ...
                                            background: StyledRect {
                                                ...
                                                border.width: 2
                                                border.color: ComponentColors.region.panel.controlCenter.bluetooth.accent
                                    ...
                                    StyledRect {
                                        ...
                                        radius: Appearance.rounding.small
                                        color: ComponentColors.region.panel.controlCenter.bluetooth.button.tonalBg
                                        opacity: root.session.bt.editingDeviceName ? 1 : 0
                                        scale: root.session.bt.editingDeviceName ? 1 : 0.5

                                        StateLayer {
                                            color: ComponentColors.region.panel.controlCenter.bluetooth.button.tonalText
                                    ...
                                    StyledRect {
                                        ...
                                        color: Qt.alpha(ComponentColors.region.panel.controlCenter.bluetooth.accent, root.session.bt.editingDeviceName ? 1 : 0)

                                        StateLayer {
                                            color: root.session.bt.editingDeviceName ? ComponentColors.region.panel.controlCenter.bluetooth.onAccent : ComponentColors.region.panel.controlCenter.bluetooth.text
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    StyledRect {
                                        ...
                                        color: ComponentColors.region.panel.controlCenter.bluetooth.accent
                                    }
            ...
            StyledClippingRect {
                ...
                RowLayout {
                    ...
                    MaterialIcon {
                        ...
                        color: ComponentColors.region.panel.controlCenter.bluetooth.onAccent
                        fill: 1
                    }
    ...
    Item {
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.normal
            color: root.session.bt.fabMenuOpen ? ComponentColors.region.panel.controlCenter.bluetooth.accent : ComponentColors.region.panel.controlCenter.bluetooth.accent
            ...
            StateLayer {
                ...
                color: root.session.bt.fabMenuOpen ? ComponentColors.region.panel.controlCenter.bluetooth.onAccent : ComponentColors.region.panel.controlCenter.bluetooth.onAccent
