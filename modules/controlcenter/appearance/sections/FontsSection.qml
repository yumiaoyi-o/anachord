        ...
        Loader {
            ...
            sourceComponent: StyledListView {
                ...
                delegate: StyledRect {
                    ...
                    color: Qt.alpha(Colours.layer(ComponentColors.region.shared.controls.common.surface), isCurrent ? Colours.layer(ComponentColors.region.shared.controls.common.surface).a : 0)
                    radius: Appearance.rounding.normal
                    border.width: isCurrent ? 1 : 0
                    border.color: ComponentColors.region.shared.controls.common.accent
