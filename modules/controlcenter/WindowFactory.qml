...
Singleton {
    ...
    Component {
        ...
        FloatingWindow {
            ...
            color: Colours.layer(ComponentColors.region.shared.controls.common.surfaceBase, 0)
            ...
            title: qsTr("Anachord Settings - %1").arg(cc.active.slice(0, 1).toUpperCase() + cc.active.slice(1))
