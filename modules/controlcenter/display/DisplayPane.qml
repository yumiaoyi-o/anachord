        ...
        ColumnLayout {
            ...
            SectionContainer {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.panel.controlCenter.display.subtext
                }
            }
            ...
            SectionContainer {
                ...
                ColumnLayout {
                    ...
                    StyledRect {
                        ...
                        color: ComponentColors.region.panel.controlCenter.display.surfaceHigh
                        ...
                        RowLayout {
                            ...
                            StyledTextField {
                                ...
                                color: ComponentColors.region.panel.controlCenter.display.text
                                font.pointSize: Appearance.font.size.small
