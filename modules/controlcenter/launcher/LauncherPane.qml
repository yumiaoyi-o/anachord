        ...
        leftContent: Component {
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.panel.controlCenter.launcher.border
                }
                ...
                StyledRect {
                    ...
                    color: Colours.layer(ComponentColors.region.panel.controlCenter.launcher.surface, 2)
                    ...
                    MaterialIcon {
                        ...
                        text: "search"
                        color: ComponentColors.region.panel.controlCenter.launcher.subtext
                    }
                ...
                Loader {
                    ...
                    sourceComponent: StyledListView {
                        ...
                        delegate: StyledRect {
                            ...
                            color: isSelected ? Colours.layer(ComponentColors.region.panel.controlCenter.launcher.surface, 2) : "transparent"
