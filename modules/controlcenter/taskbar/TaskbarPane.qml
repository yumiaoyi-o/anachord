...
Item {
    ...
    property string barMode: Config.bar.mode ?? "persistent"
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        SectionContainer {
                            ...
                            StyledRect {
                                ...
                                color: Colours.layer(ComponentColors.region.panel.controlCenter.taskbar.surface, 2)
                    ...
                    ColumnLayout {
                        ...
                        SectionContainer {
                            ...
                            StyledRect {
                                Layout.fillWidth: true
                                implicitHeight: modeColumn.implicitHeight + Appearance.padding.large * 2
                                radius: Appearance.rounding.normal
                                color: Colours.layer(ComponentColors.region.panel.controlCenter.taskbar.surface, 2)
                                ...
                                ColumnLayout {
                                    ...
                                    StyledRadioButton {
                                        ...
                                        checked: root.barMode === "persistent"
                                        onClicked: {
                                            root.barMode = "persistent";
                                            root.saveConfig();
                                        }
                                    }

                                    StyledRadioButton {
                                        text: qsTr("Hide on empty desktop")
                                        checked: root.barMode === "hideOnEmpty"
                                        onClicked: {
                                            root.barMode = "hideOnEmpty";
                                            root.saveConfig();
                                        }
                                    }
                                    ...
                                    StyledRadioButton {
                                        text: qsTr("Auto hide")
                                        checked: root.barMode === "autoHide"
                                        onClicked: {
                                            root.barMode = "autoHide";
                                            root.saveConfig();
                                        }
                                    }
                                }
