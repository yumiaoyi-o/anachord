...
ColumnLayout {
    ...
    Item {
        ...
        StateLayer {
            anchors.fill: parent
            color: ComponentColors.region.shared.controls.common.text
    ...
    Item {
        ...
        StyledRect {
            ...
            anchors.fill: parent
            radius: Appearance.rounding.normal
            color: Colours.transparency.enabled ? Colours.layer(ComponentColors.region.shared.controls.common.surface, root.nested ? 3 : 2) : (root.nested ? ComponentColors.region.shared.controls.common.surfaceHigh : ComponentColors.region.shared.controls.common.surface)
