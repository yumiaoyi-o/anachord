...
Row {
    ...
    property color colour: type == SplitButton.Filled ? ComponentColors.region.shared.controls.button.filledBg : ComponentColors.region.shared.controls.button.tonalBg
    property color textColour: type == SplitButton.Filled ? ComponentColors.region.shared.controls.button.filledText : ComponentColors.region.shared.controls.button.tonalText
    property color disabledColour: Qt.alpha(ComponentColors.region.shared.controls.common.text, 0.1)
    property color disabledTextColour: Qt.alpha(ComponentColors.region.shared.controls.common.text, 0.38)
