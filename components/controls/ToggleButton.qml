...
StyledRect {
    ...
    readonly property color toggledForeground: ComponentColors.region.shared.controls.common.onAccent
    ...
    color: toggled ? ComponentColors.region.shared.controls.common.accent : Colours.layer(ComponentColors.region.shared.controls.common.surfaceHigh)

    StateLayer {
        id: toggleStateLayer

        color: root.toggled ? root.toggledForeground : ComponentColors.region.shared.controls.common.text
