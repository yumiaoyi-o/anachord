...
Switch {
    ...
    indicator: StyledRect {
        ...
        color: root.checked ? ComponentColors.region.shared.controls.toggle.active : Colours.layer(ComponentColors.region.shared.controls.toggle.inactive, root.cLayer)
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.full
            color: ComponentColors.region.shared.controls.toggle.thumb
            ...
            StyledRect {
                ...
                color: root.checked ? ComponentColors.region.shared.controls.toggle.active : ComponentColors.region.shared.controls.common.text
            ...
            Shape {
                ...
                ShapePath {
                    ...
                    strokeColor: root.checked ? ComponentColors.region.shared.controls.toggle.active : ComponentColors.region.shared.controls.toggle.inactive
