...
ColumnLayout {
    ...
    StyledRect {
        ...
        color: pickerOpen ? Colours.layer(ComponentColors.region.panel.controlCenter.appearance.colorPicker.surface, 3)
                          : Colours.layer(ComponentColors.region.panel.controlCenter.appearance.colorPicker.surface, 2)
        ...
        RowLayout {
            ...
            StyledRect {
                ...
                color: root.value
                border.width: 1
                border.color: Qt.alpha(ComponentColors.region.panel.controlCenter.appearance.colorPicker.border, 0.4)
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.panel.controlCenter.appearance.colorPicker.subtext
                    Layout.fillWidth: true
                    wrapMode: Text.Wrap
                }
            }
            ...
            MaterialIcon {
                ...
                color: ComponentColors.isHighlighted(root.tokenKey)
                           ? ComponentColors.region.panel.controlCenter.appearance.colorPicker.accent
                           : ComponentColors.region.panel.controlCenter.appearance.colorPicker.subtext
            ...
            MaterialIcon {
                ...
                text: "edit"
                font.pointSize: Appearance.font.size.small
                color: ComponentColors.region.panel.controlCenter.appearance.colorPicker.accent
            }
            ...
            StyledRect {
                ...
                radius: Appearance.rounding.small
                color: hexInput.activeFocus ? Colours.layer(ComponentColors.region.panel.controlCenter.appearance.colorPicker.surface, 3)
                                            : Colours.layer(ComponentColors.region.panel.controlCenter.appearance.colorPicker.surface, 2)
                border.width: 1
                border.color: hexInput.activeFocus ? ComponentColors.region.panel.controlCenter.appearance.colorPicker.accent
                                                   : Qt.alpha(ComponentColors.region.panel.controlCenter.appearance.colorPicker.border, 0.3)
    ...
    Item {
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.normal
            color: Colours.layer(ComponentColors.region.panel.controlCenter.appearance.colorPicker.surfaceHigh, 2)
            border.width: 1
            border.color: Qt.alpha(ComponentColors.region.panel.controlCenter.appearance.colorPicker.border, 0.2)
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    StyledRect {
                        ...
                        color: root.value
                        border.width: 1
                        border.color: Qt.alpha(ComponentColors.region.panel.controlCenter.appearance.colorPicker.border, 0.3)
                    }
