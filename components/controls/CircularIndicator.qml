...
BusyIndicator {
    ...
    property color fgColour: ComponentColors.region.shared.controls.common.accent
    property color bgColour: ComponentColors.region.shared.controls.button.tonalBg
