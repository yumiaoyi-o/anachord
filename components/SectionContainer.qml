...
StyledRect {
    ...
    color: Colours.transparency.enabled ? Colours.layer(ComponentColors.region.shared.controls.common.surface, 2) : ComponentColors.region.shared.controls.common.surfaceHigh
