    ...
    RowLayout {
        ...
        Item {
            ...
            MaterialIcon {
                ...
                color: root.dialog.cwd.length === 1 ? ComponentColors.region.shared.controls.common.border : ComponentColors.region.shared.controls.common.text
                grade: 200
            }
        }
                        ...
                        Item {
                            ...
                            Loader {
                                ...
                                sourceComponent: MaterialIcon {
                                    text: "home"
                                    color: root.dialog.cwd.length === 1 ? ComponentColors.region.shared.controls.common.text : ComponentColors.region.shared.controls.common.subtext
                                    fill: 1
                                }
                            }
                            ...
                            StyledText {
                                ...
                                color: folder.index < root.dialog.cwd.length - 1 ? ComponentColors.region.shared.controls.common.subtext : ComponentColors.region.shared.controls.common.text
                                font.bold: true
                            }
                        }
                    }
