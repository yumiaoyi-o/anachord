    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            StyledRect {
                ...
                color: Qt.alpha(ComponentColors.region.shared.controls.button.tonalBg, selected ? 1 : 0)

                StateLayer {
                    color: place.selected ? ComponentColors.region.shared.controls.button.tonalText : ComponentColors.region.shared.controls.common.text
