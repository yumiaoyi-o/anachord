...
Item {
    ...
    Item {
        ...
        StyledRect {
            ...
            color: ComponentColors.region.dashboard.tabs.indicator
    ...
    StyledRect {
        ...
        implicitHeight: 1
        color: ComponentColors.region.dashboard.tabs.divider
    }
        ...
        contentItem: CustomMouseArea {
            ...
            ClippingRectangle {
                ...
                StyledRect {
                    ...
                    color: tab.current ? ComponentColors.region.dashboard.tabs.activeIcon : ComponentColors.region.dashboard.tabs.inactiveIcon
            ...
            StyledText {
                ...
                text: tab.text
                color: tab.current ? ComponentColors.region.dashboard.tabs.activeLabel : ComponentColors.region.dashboard.tabs.inactiveLabel
            }
        }
    }
}
