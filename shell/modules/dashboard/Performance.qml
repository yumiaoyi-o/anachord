...
RowLayout {
    ...
    component Resource: Item {
        ...
        property color fg1: ComponentColors.region.dashboard.performance.arc.fg1
        property color fg2: ComponentColors.region.dashboard.performance.arc.fg2
        property color bg1: ComponentColors.region.dashboard.performance.arc.bg1
        property color bg2: ComponentColors.region.dashboard.performance.arc.bg2
        ...
        Column {
            ...
            StyledText {
                ...
                text: res.sublabel1
                color: ComponentColors.region.dashboard.performance.sublabel
