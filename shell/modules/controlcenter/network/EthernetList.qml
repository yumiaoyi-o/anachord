...
DeviceList {
    ...
    delegate: Component {
        StyledRect {
            ...
            color: Qt.alpha(Colours.layer(ComponentColors.region.panel.surface), ethernetItem.isActive ? Colours.layer(ComponentColors.region.panel.surface).a : 0)
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    radius: Appearance.rounding.normal
                    color: modelData.connected ? ComponentColors.region.panel.accent : Colours.layer(ComponentColors.region.panel.surfaceHigh)

                    StyledRect {
                        anchors.fill: parent
                        radius: parent.radius
                        color: Qt.alpha(modelData.connected ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text, stateLayer.pressed ? 0.1 : stateLayer.containsMouse ? 0.08 : 0)
                    }
                    ...
                    MaterialIcon {
                        ...
                        color: modelData.connected ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            color: modelData.connected ? ComponentColors.region.panel.accent : ComponentColors.region.panel.border
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.panel.accent, modelData.connected ? 1 : 0)
