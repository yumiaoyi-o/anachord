...
Item {
    ...
    StyledRect {
        ...
        color: Colours.layer(ComponentColors.region.panel.surfaceBase, 0)
        opacity: root.session.network.showPasswordDialog && !root.isClosing ? 1 : 0
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: connectButton.hasError ? ComponentColors.region.state.error : ComponentColors.region.panel.subtext
                font.pointSize: Appearance.font.size.small
                font.weight: 400
            ...
            Item {
                ...
                StyledRect {
                    anchors.fill: parent
                    radius: Appearance.rounding.normal
                    color: passwordContainer.activeFocus ? Qt.lighter(Colours.layer(ComponentColors.region.panel.surface), 1.05) : Colours.layer(ComponentColors.region.panel.surface)
                    ...
                    border.color: {
                        ...
                        return root.visible ? ComponentColors.region.panel.border : "transparent";
                    }
