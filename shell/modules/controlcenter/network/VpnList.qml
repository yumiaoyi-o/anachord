    ...
    ListView {
        ...
        delegate: Component {
            StyledRect {
                ...
                color: Qt.alpha(Colours.layer(ComponentColors.region.panel.surface), (root.session && root.session.vpn && root.session.vpn.active === modelData) ? Colours.layer(ComponentColors.region.panel.surface).a : 0)
                ...
                RowLayout {
                    ...
                    StyledRect {
                        ...
                        radius: Appearance.rounding.normal
                        color: modelData.enabled && VPN.connected ? ComponentColors.region.panel.accent : Colours.layer(ComponentColors.region.panel.surfaceHigh)
                        ...
                        MaterialIcon {
                            ...
                            color: modelData.enabled && VPN.connected ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
                        }
                    }
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                ...
                                color: modelData.enabled ? (VPN.connected ? ComponentColors.region.panel.accent : ComponentColors.region.panel.text) : ComponentColors.region.panel.border
                    ...
                    StyledRect {
                        ...
                        color: Qt.alpha(ComponentColors.region.panel.accent, VPN.connected && modelData.enabled ? 1 : 0)
                        ...
                        MaterialIcon {
                            ...
                            color: VPN.connected && modelData.enabled ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
                        }
                    }
