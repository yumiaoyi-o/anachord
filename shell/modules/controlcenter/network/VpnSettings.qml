        ...
        ListView {
            ...
            delegate: Component {
                StyledRect {
                    ...
                    color: Colours.layer(ComponentColors.region.panel.surfaceHigh)
                    ...
                    RowLayout {
                        ...
                        MaterialIcon {
                            ...
                            color: modelData.isActive ? ComponentColors.region.panel.accent : ComponentColors.region.panel.border
                        }
