        ...
        StyledRect {
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    radius: Appearance.rounding.normal
                    color: modelData.active ? ComponentColors.region.panel.accent : Colours.layer(ComponentColors.region.panel.surfaceHigh)
                    ...
                    MaterialIcon {
                        ...
                        color: modelData.active ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
                    }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            color: modelData.active ? ComponentColors.region.panel.accent : ComponentColors.region.panel.border
                            font.pointSize: Appearance.font.size.small
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.panel.accent, modelData.active ? 1 : 0)
