...
GridView {
    ...
    delegate: Item {
        ...
        StyledClippingRect {
            ...
            Rectangle {
                ...
                gradient: Gradient {
                    GradientStop {
                        position: 0.0
                        color: Qt.rgba(ComponentColors.region.panel.surfaceBase.r, ComponentColors.region.panel.surfaceBase.g, ComponentColors.region.panel.surfaceBase.b, 0)
                    }
                    GradientStop {
                        position: 0.3
                        color: Qt.rgba(ComponentColors.region.panel.surfaceBase.r, ComponentColors.region.panel.surfaceBase.g, ComponentColors.region.panel.surfaceBase.b, 0.7)
                    }
                    GradientStop {
                        position: 0.6
                        color: Qt.rgba(ComponentColors.region.panel.surfaceBase.r, ComponentColors.region.panel.surfaceBase.g, ComponentColors.region.panel.surfaceBase.b, 0.9)
                    }
                    GradientStop {
                        position: 1.0
                        color: Qt.rgba(ComponentColors.region.panel.surfaceBase.r, ComponentColors.region.panel.surfaceBase.g, ComponentColors.region.panel.surfaceBase.b, 0.95)
                    }
                }
        ...
        Rectangle {
            ...
            border.color: ComponentColors.region.panel.accent
            antialiasing: true
            smooth: true
        ...
        StyledText {
            ...
            font.weight: 500
            color: isCurrent ? ComponentColors.region.panel.accent : ComponentColors.region.panel.text
