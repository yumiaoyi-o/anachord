        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.panel.accent, root.session.bt.editingAdapterName ? 1 : 0)

                    StateLayer {
                        color: root.session.bt.editingAdapterName ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
