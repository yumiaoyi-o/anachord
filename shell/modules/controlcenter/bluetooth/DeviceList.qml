...
DeviceList {
    ...
    delegate: Component {
        StyledRect {
            ...
            color: Qt.alpha(Colours.layer(ComponentColors.region.panel.surface), root.activeItem === modelData ? Colours.layer(ComponentColors.region.panel.surface).a : 0)
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    radius: Appearance.rounding.normal
                    color: device.connected ? ComponentColors.region.panel.accent : (device.modelData && device.modelData.bonded) ? ComponentColors.region.panel.button.tonalBg : Colours.layer(ComponentColors.region.panel.surfaceHigh)

                    StyledRect {
                        anchors.fill: parent
                        radius: parent.radius
                        color: Qt.alpha(device.connected ? ComponentColors.region.panel.onAccent : (device.modelData && device.modelData.bonded) ? ComponentColors.region.panel.button.tonalText : ComponentColors.region.panel.text, stateLayer.pressed ? 0.1 : stateLayer.containsMouse ? 0.08 : 0)
                    }
                    ...
                    MaterialIcon {
                        ...
                        color: device.connected ? ComponentColors.region.panel.onAccent : (device.modelData && device.modelData.bonded) ? ComponentColors.region.panel.button.tonalText : ComponentColors.region.panel.subtext
                        font.pointSize: Appearance.font.size.large
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(ComponentColors.region.panel.accent, device.connected ? 1 : 0)
                    ...
                    StateLayer {
                        color: device.connected ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
