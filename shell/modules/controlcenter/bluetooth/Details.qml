...
StyledFlickable {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    StyledRect {
                                        ...
                                        radius: Appearance.rounding.small
                                        color: ComponentColors.region.panel.button.tonalBg
                                        opacity: root.session.bt.editingDeviceName ? 1 : 0
                                    ...
                                    StyledRect {
                                        ...
                                        color: Qt.alpha(ComponentColors.region.panel.accent, root.session.bt.editingDeviceName ? 1 : 0)

                                        StateLayer {
                                            color: root.session.bt.editingDeviceName ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.text
            ...
            StyledClippingRect {
                ...
                RowLayout {
                    ...
                    MaterialIcon {
                        ...
                        color: ComponentColors.region.panel.onAccent
                        fill: 1
                    }
    ...
    Item {
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.normal
            color: root.session.bt.fabMenuOpen ? ComponentColors.region.panel.accent : ComponentColors.region.panel.accent
            ...
            StateLayer {
                ...
                color: root.session.bt.fabMenuOpen ? ComponentColors.region.panel.onAccent : ComponentColors.region.panel.onAccent
