...
Scope {
    ...
    CustomShortcut {
        ...
        onPressed: {
            if (ComponentColors.previewLocked || root.hasFullscreen)
                return;
    ...
    CustomShortcut {
        ...
        onPressed: lockFromShortcut.running = true
    }
    ...
    CustomShortcut {
        ...
        onReleased: {
            if (!root.launcherInterrupted && !root.hasFullscreen && !ComponentColors.previewLocked) {
                const visibilities = Visibilities.getForActive();
