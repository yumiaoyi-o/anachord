...
StyledRect {
    ...
    color: root.urgency === "critical" ? ComponentColors.region.lock.notif.bg : Colours.layer(ComponentColors.region.lock.surfaceHigh, 2)
        ...
        Item {
            ...
            Component {
                ...
                ColouredIcon {
                    ...
                    colour: root.urgency === "critical" ? ComponentColors.region.state.error : root.urgency === "low" ? ComponentColors.region.lock.text : ComponentColors.region.lock.notif.text
            ...
            Component {
                ...
                MaterialIcon {
                    ...
                    color: root.urgency === "critical" ? ComponentColors.region.state.error : root.urgency === "low" ? ComponentColors.region.lock.text : ComponentColors.region.lock.notif.text
            ...
            ClippingRectangle {
                anchors.fill: parent
                color: root.urgency === "critical" ? ComponentColors.region.state.error : root.urgency === "low" ? Colours.layer(ComponentColors.region.lock.surfaceHighest, 3) : ComponentColors.region.lock.notif.bg
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    ...
                    color: root.urgency === "critical" ? ComponentColors.region.state.error : root.urgency === "low" ? ComponentColors.region.lock.surfaceHighest : ComponentColors.region.lock.notif.bg
                    radius: Appearance.rounding.full
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.lock.border
                    font.pointSize: Appearance.font.size.small
                }
                ...
                StyledRect {
                    ...
                    color: root.urgency === "critical" ? ComponentColors.region.state.error : Colours.layer(ComponentColors.region.lock.surfaceHighest, 2)
                    radius: Appearance.rounding.full
                    ...
                    StateLayer {
                        color: root.urgency === "critical" ? ComponentColors.region.state.error : ComponentColors.region.lock.text
    ...
    component NotifLine: StyledText {
        ...
        text: {
            ...
            const colour = root.urgency === "critical" ? ComponentColors.region.lock.accentSecondary : ComponentColors.region.lock.border;
        ...
        color: root.urgency === "critical" ? ComponentColors.region.lock.notif.text : ComponentColors.region.lock.text
