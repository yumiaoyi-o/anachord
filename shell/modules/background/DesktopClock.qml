...
Item {
    ...
    readonly property color safePrimary: useLightSet ? "#FFFFFF" : ComponentColors.region.background.clock.hours
    readonly property color safeSecondary: useLightSet ? "#E0E0E0" : ComponentColors.region.background.clock.minutes
    readonly property color safeTertiary: useLightSet ? "#C8C8C8" : ComponentColors.region.background.clock.separator
    ...
    Item {
        ...
        layer.effect: MultiEffect {
            shadowEnabled: true
            shadowColor: ComponentColors.region.state.shadow
        ...
        StyledRect {
            ...
            color: ComponentColors.region.background.clock.dateBg
