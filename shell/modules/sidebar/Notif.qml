...
StyledRect {
    ...
    color: {
        const c = root.modelData.urgency === "critical" ? ComponentColors.region.sidebar.notif.criticalBg : Colours.layer(ComponentColors.region.sidebar.notif.normalBg, 2);
    ...
    StyledText {
        ...
        color: root.modelData.urgency === "critical" ? ComponentColors.region.sidebar.notif.criticalText : ComponentColors.region.sidebar.notif.normalText
    ...
    WrappedLoader {
        ...
        sourceComponent: StyledText {
            ...
            color: root.modelData.urgency === "critical" ? ComponentColors.region.sidebar.notif.criticalBody : ComponentColors.region.sidebar.notif.normalBody
            elide: Text.ElideRight
        }
    }
    ...
    WrappedLoader {
        ...
        sourceComponent: StyledText {
            ...
            color: ComponentColors.region.sidebar.notif.time
