...
StyledRect {
    ...
    color: Colours.layer(ComponentColors.region.sidebar.group.surface, 2)
        ...
        Item {
            ...
            Component {
                ...
                ColouredIcon {
                    ...
                    colour: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.group.icon.critical : root.urgency === NotificationUrgency.Low ? ComponentColors.region.sidebar.group.icon.low : ComponentColors.region.sidebar.group.icon.normal
            ...
            Component {
                ...
                MaterialIcon {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.group.icon.critical : root.urgency === NotificationUrgency.Low ? ComponentColors.region.sidebar.group.icon.low : ComponentColors.region.sidebar.group.icon.normal
            ...
            StyledClippingRect {
                anchors.fill: parent
                color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.group.badge.criticalBg : root.urgency === NotificationUrgency.Low ? Colours.layer(ComponentColors.region.sidebar.group.badge.lowBg, 3) : ComponentColors.region.sidebar.group.badge.normalBg
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.group.badge.criticalBg : root.urgency === NotificationUrgency.Low ? ComponentColors.region.sidebar.group.badge.lowBg : ComponentColors.region.sidebar.group.badge.normalBg
                    radius: Appearance.rounding.full
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: root.modelData
                    color: ComponentColors.region.sidebar.group.appName
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.sidebar.group.time
                    font.pointSize: Appearance.font.size.small
                }
                ...
                StyledRect {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.group.counter.criticalBg : Colours.layer(ComponentColors.region.sidebar.group.counter.normalBg, 3)
                    radius: Appearance.rounding.full

                    StateLayer {
                        color: root.urgency === NotificationUrgency.Critical ? ComponentColors.region.sidebar.group.counter.criticalText : ComponentColors.region.sidebar.group.counter.normalText
