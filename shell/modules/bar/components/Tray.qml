...
StyledRect {
    ...
    color: Qt.alpha(ComponentColors.region.bar.workspace.surface, (Config.bar.tray.background && items.count > 0) ? Colours.layer(ComponentColors.region.bar.workspace.surface).a : 0)
