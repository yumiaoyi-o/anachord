...
StyledRect {
    ...
    property color colour: ComponentColors.region.bar.icon
    readonly property alias items: iconColumn

    color: Qt.alpha(ComponentColors.region.bar.workspace.surface, Colours.layer(ComponentColors.region.bar.workspace.surface).a)
    ...
    ColumnLayout {
        ...
        WrappedLoader {
            ...
            sourceComponent: MaterialIcon {
                ...
                color: !UPower.onBattery || UPower.displayDevice.percentage > 0.2 ? root.colour : ComponentColors.region.state.error
                fill: 1
            }
        }
    }
