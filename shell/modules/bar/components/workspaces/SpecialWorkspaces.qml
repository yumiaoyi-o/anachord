    ...
    Loader {
        ...
        sourceComponent: Item {
            StyledClippingRect {
                ...
                color: ComponentColors.region.bar.accentTertiary
                radius: Appearance.rounding.full

                Colouriser {
                    source: view
                    sourceColor: ComponentColors.region.bar.text
                    colorizationColor: ComponentColors.region.bar.onAccentTertiary
