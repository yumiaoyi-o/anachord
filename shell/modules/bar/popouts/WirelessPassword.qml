...
ColumnLayout {
    ...
    StyledRect {
        ...
        color: Colours.layer(ComponentColors.region.bar.popout.surface)
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: ComponentColors.region.bar.disabledText
            ...
            StyledText {
                ...
                color: connectButton.hasError ? ComponentColors.region.state.error : ComponentColors.region.bar.popout.subtext
                font.pointSize: Appearance.font.size.small
                font.weight: 400
            ...
            FocusScope {
                ...
                StyledRect {
                    anchors.fill: parent
                    radius: Appearance.rounding.normal
                    color: passwordContainer.activeFocus ? Qt.lighter(Colours.layer(ComponentColors.region.bar.popout.surface), 1.05) : Colours.layer(ComponentColors.region.bar.popout.surface)
                    ...
                    border.color: {
                        ...
                        if (passwordContainer.activeFocus) {
                            return ComponentColors.region.bar.accent;
                        }
                        return root.shouldBeVisible ? ComponentColors.region.bar.disabledText : "transparent";
                    }
                ...
                ListView {
                    ...
                    delegate: StyledRect {
                        ...
                        color: ComponentColors.region.bar.popout.text
            ...
            RowLayout {
                ...
                TextButton {
                    ...
                    Layout.fillWidth: true
                    Layout.minimumHeight: Appearance.font.size.normal + Appearance.padding.normal * 2
                    inactiveColour: ComponentColors.region.bar.accent
                    inactiveOnColour: ComponentColors.region.bar.onAccent
                    text: qsTr("Connect")
