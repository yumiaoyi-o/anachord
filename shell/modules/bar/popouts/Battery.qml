...
Column {
            ...
            Column {
                ...
                Row {
                    ...
                    MaterialIcon {
                        ...
                        text: "warning"
                        color: ComponentColors.region.state.onError
                    }
    ...
    component Profile: Item {
        ...
        StateLayer {
            radius: Appearance.rounding.full
            color: profiles.current === parent.icon ? ComponentColors.region.bar.onAccent : ComponentColors.region.bar.popout.text
        ...
        MaterialIcon {
            ...
            color: profiles.current === text ? ComponentColors.region.bar.onAccent : ComponentColors.region.bar.popout.text
