...
ColumnLayout {
    ...
    StyledText {
        ...
        color: ComponentColors.region.bar.popout.subtext
    ...
    Repeater {
        ...
        RowLayout {
            ...
            MaterialIcon {
                ...
                color: networkItem.modelData.active ? ComponentColors.region.bar.accent : ComponentColors.region.bar.popout.subtext
            }
            ...
            StyledText {
                ...
                color: networkItem.modelData.active ? ComponentColors.region.bar.accent : ComponentColors.region.bar.popout.text
            }
            ...
            StyledRect {
                ...
                color: Qt.alpha(ComponentColors.region.bar.accent, networkItem.modelData.active ? 1 : 0)
                ...
                StateLayer {
                    color: networkItem.modelData.active ? ComponentColors.region.bar.onAccent : ComponentColors.region.bar.popout.text
    ...
    Repeater {
        ...
        RowLayout {
            ...
            MaterialIcon {
                text: "cable"
                color: ethernetItem.modelData.connected ? ComponentColors.region.bar.accent : ComponentColors.region.bar.popout.subtext
            }
            ...
            StyledText {
                ...
                color: ethernetItem.modelData.connected ? ComponentColors.region.bar.accent : ComponentColors.region.bar.popout.text
            }
            ...
            StyledRect {
                ...
                radius: Appearance.rounding.full
                color: Qt.alpha(ComponentColors.region.bar.accent, ethernetItem.modelData.connected ? 1 : 0)
                ...
                StateLayer {
                    color: ethernetItem.modelData.connected ? ComponentColors.region.bar.onAccent : ComponentColors.region.bar.popout.text
