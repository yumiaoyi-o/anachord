    ...
    Repeater {
        ...
        RowLayout {
            ...
            StyledRect {
                ...
                color: Qt.alpha(ComponentColors.region.bar.accent, device.modelData.state === BluetoothDeviceState.Connected ? 1 : 0)
                ...
                StateLayer {
                    color: device.modelData.state === BluetoothDeviceState.Connected ? ComponentColors.region.bar.onAccent : ComponentColors.region.bar.popout.text
