...
Item {
    ...
    Row {
        ...
        MaterialIcon {
            ...
            color: ComponentColors.region.launcher.emptyState.icon
        ...
        Column {
            ...
            StyledText {
                ...
                color: ComponentColors.region.launcher.emptyState.title
            ...
            StyledText {
                ...
                color: ComponentColors.region.launcher.emptyState.subtitle
