    ...
    sourceComponent: MouseArea {
        ...
        Item {
            ...
            StyledRect {
                ...
                color: ComponentColors.region.utilities.modal.scrim
            }
            ...
            Shape {
                ...
                ShapePath {
                    ...
                    fillGradient: LinearGradient {
                        ...
                        GradientStop {
                            position: 0
                            color: Qt.alpha(ComponentColors.region.utilities.modal.scrim, 0)
                        }
                        GradientStop {
                            position: 1
                            color: ComponentColors.region.utilities.modal.scrim
        ...
        StyledRect {
            ...
            color: ComponentColors.region.utilities.modal.surface
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: ComponentColors.region.utilities.modal.text
