...
StyledRect {
    ...
    RowLayout {
        ...
        StyledRect {
            ...
            color: IdleInhibitor.enabled ? ComponentColors.region.utilities.toggle.activeBg : ComponentColors.region.utilities.toggle.inactiveBg
            ...
            MaterialIcon {
                ...
                text: "coffee"
                color: IdleInhibitor.enabled ? ComponentColors.region.utilities.toggle.activeIcon : ComponentColors.region.utilities.toggle.inactiveIcon
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: ComponentColors.region.utilities.toggle.label
    ...
    Loader {
        ...
        sourceComponent: StyledRect {
            ...
            radius: Appearance.rounding.full
            color: ComponentColors.region.utilities.action.accent
            ...
            StyledText {
                ...
                color: ComponentColors.region.utilities.action.onAccent
