...
StyledRect {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Toggle {
                icon: "settings"
                inactiveOnColour: ComponentColors.region.utilities.toggle.labelInactive
                toggle: false
                onClicked: {
    ...
    component Toggle: IconButton {
        ...
        inactiveColour: Colours.layer(ComponentColors.region.utilities.toggle.pillInactive, 2)
        toggle: true
