...
Singleton {
    ...
    function serializeBar(): var {
        return {
            ...
            mediaLines: {
                lineCount: bar.mediaLines.lineCount,
                glowOpacity: bar.mediaLines.glowOpacity,
                mediumOpacity: bar.mediaLines.mediumOpacity,
                coreOpacity: bar.mediaLines.coreOpacity,
                timeMode: bar.mediaLines.timeMode
            },
            entries: bar.entries
        };
    }
    ...
    function serializeDisplay(): var {
        return {
            lockTimeout: display.lockTimeout
        };
    }
    ...
    function serializeLock(): var {
        return {
            ...
            wavyLines: {
                xGap: lock.wavyLines.xGap,
                amplitude: lock.wavyLines.amplitude,
                noiseScale: lock.wavyLines.noiseScale,
                animSpeed: lock.wavyLines.animSpeed,
                pointDensity: lock.wavyLines.pointDensity,
                glowOpacity: lock.wavyLines.glowOpacity,
                mediumOpacity: lock.wavyLines.mediumOpacity,
                coreOpacity: lock.wavyLines.coreOpacity,
                glowWidth: lock.wavyLines.glowWidth,
                mediumWidth: lock.wavyLines.mediumWidth,
                coreWidth: lock.wavyLines.coreWidth
            }
        };
    }
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property DisplayConfig display: DisplayConfig {}
