...
Item {
    ...
    StyledRect {
        ...
        anchors.fill: parent
        color: inputHover.containsMouse || inputField.activeFocus ? Colours.layer(ComponentColors.region.panel.surface, 3) : Colours.layer(ComponentColors.region.panel.surface, 2)
        radius: Appearance.rounding.small
        border.width: 1
        border.color: inputField.activeFocus ? ComponentColors.region.panel.accent : Qt.alpha(ComponentColors.region.panel.textDisabled, 0.3)
