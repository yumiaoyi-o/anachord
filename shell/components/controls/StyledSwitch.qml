...
Switch {
    ...
    indicator: StyledRect {
        ...
        color: root.checked ? ComponentColors.region.panel.toggle.active : Colours.layer(ComponentColors.region.panel.toggle.inactive, root.cLayer)
        ...
        StyledRect {
            ...
            StyledRect {
                ...
                color: root.checked ? ComponentColors.region.panel.toggle.active : ComponentColors.region.panel.text
            ...
            Shape {
                ...
                ShapePath {
                    ...
                    strokeColor: root.checked ? ComponentColors.region.panel.toggle.active : ComponentColors.region.panel.toggle.inactive
