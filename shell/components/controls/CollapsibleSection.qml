...
ColumnLayout {
    ...
    Item {
        ...
        StyledRect {
            ...
            anchors.fill: parent
            radius: Appearance.rounding.normal
            color: Colours.transparency.enabled ? Colours.layer(ComponentColors.region.panel.surface, root.nested ? 3 : 2) : (root.nested ? ComponentColors.region.panel.surfaceHigh : ComponentColors.region.panel.surface)
