...
Row {
    ...
    property color colour: type == SplitButton.Filled ? ComponentColors.region.panel.button.filledBg : ComponentColors.region.panel.button.tonalBg
    property color textColour: type == SplitButton.Filled ? ComponentColors.region.panel.button.filledText : ComponentColors.region.panel.button.tonalText
    property color disabledColour: Qt.alpha(ComponentColors.region.panel.text, 0.1)
    property color disabledTextColour: Qt.alpha(ComponentColors.region.panel.text, 0.38)
