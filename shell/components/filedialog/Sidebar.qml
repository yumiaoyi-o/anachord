    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            StyledRect {
                ...
                color: Qt.alpha(ComponentColors.region.panel.button.tonalBg, selected ? 1 : 0)

                StateLayer {
                    color: place.selected ? ComponentColors.region.panel.button.tonalText : ComponentColors.region.panel.text
