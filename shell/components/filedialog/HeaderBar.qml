    ...
    RowLayout {
        ...
        Item {
            ...
            MaterialIcon {
                ...
                color: root.dialog.cwd.length === 1 ? ComponentColors.region.panel.border : ComponentColors.region.panel.text
                grade: 200
            }
        }
                        ...
                        Item {
                            ...
                            Loader {
                                ...
                                sourceComponent: MaterialIcon {
                                    text: "home"
                                    color: root.dialog.cwd.length === 1 ? ComponentColors.region.panel.text : ComponentColors.region.panel.subtext
                                    fill: 1
                                }
                            }
                            ...
                            StyledText {
                                ...
                                color: folder.index < root.dialog.cwd.length - 1 ? ComponentColors.region.panel.subtext : ComponentColors.region.panel.text
                                font.bold: true
                            }
                        }
                    }
