...
JsonObject {
    property string mode: "persistent" // "persistent", "hideOnEmpty", "autoHide"
    ...
    property MediaLines mediaLines: MediaLines {}
    ...
    component MediaLines: JsonObject {
        property int lineCount: 5
        property int glowOpacity: 8
        property int mediumOpacity: 18
        property int coreOpacity: 85
