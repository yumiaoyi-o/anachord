...
Singleton {
    ...
    function reloadDynamicConfs(): void {
        extras.batchMessage(["keyword bindlni ,Caps_Lock,global,anachord:refreshDevices", "keyword bindlni ,Num_Lock,global,anachord:refreshDevices"]);
    }
    ...
    FileView {
        ...
        path: Quickshell.env("Anachord_XKB_RULES_PATH") || "/usr/share/X11/xkb/rules/base.lst"
        onLoaded: {
